...
export default function App() {
  return (
    <>
      <Header />
      <main className="font-inter max-w-md mx-auto mt-8 p-8 rounded-3xl">
        <h1 className="text-2xl text-slate-800 tracking-tight font-plex font-semibold text-center">
          Impact
        </h1>
