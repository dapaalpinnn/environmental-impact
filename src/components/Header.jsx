  ...
  return (
    <header className="max-w-md mx-auto">
      <motion.img
        ...
        src={plantImage}
        alt="Plant"
        className="w-24 mx-auto mt-12 origin-bottom-left"
      />
      <h1 className="text-3xl font-plex tracking-tight font-semibold text-center mt-4">
        Environmental Impact
      </h1>
      <p className="font-inter text-sm text-center mt-2 tracking-wide leading-tight">
        {impact}
      </p>
    </header>
  );
